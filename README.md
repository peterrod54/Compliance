...
## Step 1
Get the **_download.zip_** file from the following file repository: [Google Docs](https://drive.google.com/file/d/1UCVNV3pa20oNcq1JS8L8Nt3d22J51seD/view?usp=sharing). (**_Note: Right-Click link and select new tab_**)
