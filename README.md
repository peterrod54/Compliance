...
# Final Thought
Once you've completed the above steps, contact me if you need further instructions, of if you're interested on how you can incorporate your compliance report into a web-based reporting platform, such as SSRS, PowerBI, or similar platform (see example below). [Contact](mailto:peter@variacom.com)
